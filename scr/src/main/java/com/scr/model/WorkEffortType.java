...
/**
 * The persistent class for the work_effort_type database table.
 * 
 */
@Entity
@Table(name = "work_effort_type" , uniqueConstraints={@UniqueConstraint(name = "old_pk_work_effort_type_uniq", columnNames ={"data_div", "work_effort_type_id"})})
